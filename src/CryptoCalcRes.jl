...
struct Rate
    rates::Union{Nothing, Dict{String, Dict{String, AssetQuantity }}}    #asset-id to  map fiat asset -> qsset qty
end
...
struct Transaction
    ...
    datetime::String
    type::String
    ins::Union{Nothing, Array{In}}
    outs::Union{Nothing, Array{Out}}
    rates::Rate
    fees::Union{Nothing, Array{Fee}}
end
...
struct CostBasisManager
    integration_asset_queues::Union{Nothing, Dict{String, Dict{String, Array{CB} }}}    #integration -> map of assetid -> array of CB
